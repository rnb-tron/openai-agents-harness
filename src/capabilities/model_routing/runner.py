...
from src.capabilities.model_routing.fallback import ModelFallback
from src.capabilities.model_routing.retry import RetryExecutor
...
class ResilientModelRunner:
    ...
    async def run(self, agent_factory: Callable, **kwargs) -> Any:
        """
        执行弹性模型调用
