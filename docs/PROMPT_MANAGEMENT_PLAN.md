...
| 位置 | 形式 | 示例 |
|---|---|---|
| [`agent_runtime.py:164`](file:///Users/wangchuang/project/openai-agent-sdk/src/application/orchestration/agent_runtime.py#L164) | `Agent(..., instructions="...")` 硬编码 | `"You are a concise assistant. Use tools when useful..."` |
| [`rolling_summary.py:33`](file:///Users/wangchuang/project/openai-agent-sdk/src/capabilities/context_compression/rolling_summary.py#L33) | 模块级常量 `_SYSTEM_PROMPT` | 摘要 prompt |
| [`advanced_agents/handoff.py`](file:///Users/wangchuang/project/openai-agent-sdk/src/capabilities/advanced_agents/handoff.py) | `instructions: str` 由调用方传入 | 各调用方自带 |
...
工程已经依赖 Langfuse 4.x,且已在 [`observability/tracer.py`](file:///Users/wangchuang/project/openai-agent-sdk/src/capabilities/observability/tracer.py) 初始化 client (`get_client()`):
...
复用 [`observability/tracer.py`](file:///Users/wangchuang/project/openai-agent-sdk/src/capabilities/observability/tracer.py) 已初始化的 client:
